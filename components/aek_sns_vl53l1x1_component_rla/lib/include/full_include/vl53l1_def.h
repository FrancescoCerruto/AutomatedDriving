...
/**
 * @file    vl53l1_def.h
 * @brief   SPC5xx vl53l1_def.h header file.
 *
 * @addtogroup vl53l1_def
 * @{
 */
 ...
 *  @{
 *
 *  VL53L1_DISTANCEMODE_SHORT : max distance in dark 136cm,max distance under strong ambient light 135cm
 *
 *  VL53L1_DISTANCEMODE_MEDIUM : max distance in dark 290cm, max distance under strong ambient light 76cm
 *
 *  VL53L1_DISTANCEMODE_LONG : max distance in dark 360cm, max distance under strong ambient light 73cm
 */

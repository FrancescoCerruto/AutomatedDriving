 ...
 * @brief   SPC5xx vl53l1_core_support.c driver code.
 *
 * @addtogroup vl53l1_core_support
 * @{
 */
...
#include "full_include/vl53l1_core_support.h"
#include "full_include/vl53l1_platform_user_data.h"
#include "full_include/vl53l1_platform_user_defines.h"

#ifdef VL53L1_LOGGING
#include "full_include/vl53l1_debug.h"
#include "full_include/vl53l1_register_debug.h"
#endif

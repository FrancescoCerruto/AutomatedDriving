 ...
 * @brief   SPC5xx  VL53L1X_api.h header file.
 *
 * @addtogroup VL53L1X_api
 * @{
 */


#ifndef _LIB_INCLUDE_VL53L1X_API_H_
#define _LIB_INCLUDE_VL53L1X_API_H_

#include "VL53L1X_support.h"
...
typedef signed char VL53L1X_ERROR;
 ...
 */
i2c_result_t VL53L1X_SetI2CAddress(uint16_t, uint8_t new_address);
 ...
 */
i2c_result_t VL53L1X_SetInterruptPolarity(uint8_t dev, uint8_t IntPol);

/**
 * @brief This function returns the current interrupt polarity
 * 1=active high (default), 0=active low
 */
i2c_result_t VL53L1X_GetInterruptPolarity(uint8_t dev, uint8_t *pIntPol);
 ...
 */
i2c_result_t VL53L1X_GetTimingBudgetInMs(uint8_t dev, uint16_t *pTimingBudgetInMs);
 ...
 */
i2c_result_t VL53L1X_GetDistanceMode(uint8_t dev, uint16_t *pDistanceMode);
 ...
 */
i2c_result_t VL53L1X_SetInterMeasurementInMs(uint8_t dev,uint32_t InterMeasurementInMs);

/**
 * @brief This function returns the Intermeasurement period in ms.
 */
i2c_result_t VL53L1X_GetInterMeasurementInMs(uint8_t dev, uint16_t * pIM);
 ...
 */
i2c_result_t VL53L1X_GetSensorId(uint8_t dev, uint16_t *id);
 ...
 */
i2c_result_t VL53L1X_GetSignalPerSpad(uint8_t dev, uint16_t *signalPerSp);

/**
 * @brief This function returns the ambient per SPAD in kcps/SPAD
 */
i2c_result_t VL53L1X_GetAmbientPerSpad(uint8_t dev, uint16_t *amb);

/**
 * @brief This function returns the returned signal in kcps.
 */
i2c_result_t VL53L1X_GetSignalRate(uint8_t dev, uint16_t *signalRate);
 ...
 */
i2c_result_t VL53L1X_GetSigmaThreshold(uint8_t dev, uint16_t *signal);
...
#endif /* _LIB_INCLUDE_VL53L1X_API_H_ */

 ...
 * @brief   SPC5xx vl53l1_error_strings.h header file.
 *
 * @addtogroup vl53l1_error_strings
 * @{
 */
#ifndef _VL53L1_ERROR_STRINGS_H_
#define _VL53L1_ERROR_STRINGS_H_
...
#endif/*_VL53L1_ERROR_STRINGS_H_*/
/** @}*/

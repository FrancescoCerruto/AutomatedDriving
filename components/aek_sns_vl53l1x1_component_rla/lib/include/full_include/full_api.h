 ...
 * @brief   SPC5xx  full_api.h header file.
 *
 * @addtogroup full_api
 * @{
 */

#ifndef LIB_FULL_API_H_
#define LIB_FULL_API_H_
 ...
 *  @attribute
    1) Dev is struct that contein the Sensor device address
...
*/
typedef void (*FULL_GetErrorSensorState_ptr)(AEK_TOF_DEV index,AEK_TOF_ERROR *state);

typedef void (*FULL_SetIRQSensorState_ptr)(AEK_TOF_DEV index);

typedef void (*FULL_GetIRQSensorState_ptr)(AEK_TOF_DEV index,volatile uint8_t *state);

typedef void (*FULL_TurnOnSensor_ptr)(AEK_TOF_DEV index);

typedef void (*FULL_TurnOffSensor_ptr)(AEK_TOF_DEV index);

typedef void (*FULL_TurnOnAllSensors_ptr)(void);

typedef void (*FULL_TurnOffAllSensors_ptr)(void);

typedef VL53L1_Error (*FULL_GetVersion_ptr)(VL53L1_Version_t *pVersion);

typedef VL53L1_Error (*FULL_GetProductRevision_ptr)(AEK_TOF_DEV index, uint8_t *pProductRevisionMajor, uint8_t *pProductRevisionMinor);

typedef VL53L1_Error (*FULL_GetDeviceInfo_ptr)(AEK_TOF_DEV index, VL53L1_DeviceInfo_t *pVL53L1_DeviceInfo);

typedef VL53L1_Error (*FULL_GetRangeStatusString_ptr)(uint8_t RangeStatus, char *pRangeStatusString);

typedef VL53L1_Error (*FULL_GetPalErrorString_ptr)(VL53L1_Error PalErrorCode, char *pPalErrorString);

typedef VL53L1_Error (*FULL_GetPalStateString_ptr)(VL53L1_State PalStateCode, char *pPalStateString);

typedef VL53L1_Error (*FULL_GetPalState_ptr)(AEK_TOF_DEV index, VL53L1_State *pPalState);

typedef VL53L1_Error (*FULL_SetDeviceAddress_ptr)(AEK_TOF_DEV index, uint8_t DeviceAddress);

typedef VL53L1_Error (*FULL_DataInit_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_StaticInit_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_WaitDeviceBooted_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_SetPresetMode_ptr)(AEK_TOF_DEV index, VL53L1_PresetModes PresetMode);

typedef VL53L1_Error (*FULL_GetPresetMode_ptr)(AEK_TOF_DEV index, VL53L1_PresetModes *pPresetMode);

typedef VL53L1_Error (*FULL_SetDistanceMode_ptr)(AEK_TOF_DEV index,VL53L1_DistanceModes DistanceMode);

typedef VL53L1_Error (*FULL_GetDistanceMode_ptr)(AEK_TOF_DEV index,VL53L1_DistanceModes *pDistanceMode);

typedef VL53L1_Error (*FULL_SetMeasurementTimingBudgetMicroSeconds_ptr)(AEK_TOF_DEV index, uint32_t MeasurementTimingBudgetMicroSeconds);

typedef VL53L1_Error (*FULL_GetMeasurementTimingBudgetMicroSeconds_ptr)(AEK_TOF_DEV index, uint32_t *pMeasurementTimingBudgetMicroSeconds);

typedef VL53L1_Error (*FULL_SetInterMeasurementPeriodMilliSeconds_ptr)(AEK_TOF_DEV index, uint32_t InterMeasurementPeriodMilliSeconds);

typedef VL53L1_Error (*FULL_GetInterMeasurementPeriodMilliSeconds_ptr)(AEK_TOF_DEV index, uint32_t *pInterMeasurementPeriodMilliSeconds);

typedef VL53L1_Error (*FULL_GetNumberOfLimitCheck_ptr)(uint16_t *pNumberOfLimitCheck);

typedef VL53L1_Error (*FULL_GetLimitCheckInfo_ptr)(uint16_t LimitCheckId, char *pLimitCheckString);

typedef VL53L1_Error (*FULL_GetLimitCheckStatus_ptr)(AEK_TOF_DEV index, uint16_t LimitCheckId, uint8_t *pLimitCheckStatus);

typedef VL53L1_Error (*FULL_SetLimitCheckEnable_ptr)(AEK_TOF_DEV index, uint16_t LimitCheckId, uint8_t LimitCheckEnable);

typedef VL53L1_Error (*FULL_GetLimitCheckEnable_ptr)(AEK_TOF_DEV index, uint16_t LimitCheckId, uint8_t *pLimitCheckEnable);

typedef VL53L1_Error (*FULL_SetLimitCheckValue_ptr)(AEK_TOF_DEV index, uint16_t LimitCheckId, FixPoint1616_t LimitCheckValue);

typedef VL53L1_Error (*FULL_GetLimitCheckValue_ptr)(AEK_TOF_DEV index, uint16_t LimitCheckId, FixPoint1616_t *pLimitCheckValue);

typedef VL53L1_Error (*FULL_GetLimitCheckCurrent_ptr)(AEK_TOF_DEV index, uint16_t LimitCheckId, FixPoint1616_t *pLimitCheckCurrent);

typedef VL53L1_Error (*FULL_SetUserROI_ptr)(AEK_TOF_DEV index, VL53L1_UserRoi_t *pUserROi);

typedef VL53L1_Error (*FULL_GetUserROI_ptr)(AEK_TOF_DEV index, VL53L1_UserRoi_t *pUserROi);

typedef VL53L1_Error (*FULL_GetNumberOfSequenceSteps_ptr)(AEK_TOF_DEV index, uint8_t *pNumberOfSequenceSteps);

typedef VL53L1_Error (*FULL_GetSequenceStepsInfo_ptr)(VL53L1_SequenceStepId SequenceStepId, char *pSequenceStepsString);

typedef VL53L1_Error (*FULL_SetSequenceStepEnable_ptr)(AEK_TOF_DEV index, VL53L1_SequenceStepId SequenceStepId, uint8_t SequenceStepEnabled);

typedef VL53L1_Error (*FULL_GetSequenceStepEnable_ptr)(AEK_TOF_DEV index, VL53L1_SequenceStepId SequenceStepId, uint8_t *pSequenceStepEnabled);

typedef VL53L1_Error (*FULL_StartMeasurement_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_StopMeasurement_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_ClearInterruptAndStartMeasurement_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_GetMeasurementDataReady_ptr)(AEK_TOF_DEV index,uint8_t *pMeasurementDataReady);

typedef VL53L1_Error (*FULL_WaitMeasurementDataReady_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_GetRangingMeasurementData_ptr)(AEK_TOF_DEV index, VL53L1_RangingMeasurementData_t *pRangingMeasurementData);

typedef VL53L1_Error (*FULL_SetTuningParameter_ptr)(AEK_TOF_DEV index, uint16_t TuningParameterId, int32_t TuningParameterValue);

typedef VL53L1_Error (*FULL_GetTuningParameter_ptr)(AEK_TOF_DEV index, uint16_t TuningParameterId, int32_t *pTuningParameterValue);

typedef VL53L1_Error (*FULL_PerformRefSpadManagement_ptr)(AEK_TOF_DEV index);

typedef VL53L1_Error (*FULL_SetXTalkCompensationEnable_ptr)(AEK_TOF_DEV index,uint8_t XTalkCompensationEnable);

typedef VL53L1_Error (*FULL_GetXTalkCompensationEnable_ptr)(AEK_TOF_DEV index,uint8_t *pXTalkCompensationEnable);

typedef VL53L1_Error (*FULL_PerformSingleTargetXTalkCalibration_ptr)(AEK_TOF_DEV index,int32_t CalDistanceMilliMeter);

typedef VL53L1_Error (*FULL_SetOffsetCalibrationMode_ptr)(AEK_TOF_DEV index, VL53L1_OffsetCalibrationModes OffsetCalibrationMode);

typedef VL53L1_Error (*FULL_PerformOffsetCalibration_ptr)(AEK_TOF_DEV index, int32_t CalDistanceMilliMeter);

typedef VL53L1_Error (*FULL_PerformOffsetSimpleCalibration_ptr)(AEK_TOF_DEV index, int32_t CalDistanceMilliMeter);

typedef VL53L1_Error (*FULL_SetCalibrationData_ptr)(AEK_TOF_DEV index, VL53L1_CalibrationData_t *pCalibrationData);

typedef VL53L1_Error (*FULL_GetCalibrationData_ptr)(AEK_TOF_DEV index, VL53L1_CalibrationData_t *pCalibrationData);

typedef VL53L1_Error (*FULL_GetOpticalCenter_ptr)(AEK_TOF_DEV index, FixPoint1616_t *pOpticalCenterX, FixPoint1616_t *pOpticalCenterY);

typedef VL53L1_Error (*FULL_SetThresholdConfig_ptr)(AEK_TOF_DEV index, VL53L1_DetectionConfig_t *pConfig);

typedef VL53L1_Error (*FULL_GetThresholdConfig_ptr)(AEK_TOF_DEV index, VL53L1_DetectionConfig_t *pConfig);
...
typedef struct
{
    ...
    *
    * 	@param[in]  AEK_TOF_DEV index 	 -> es : AEK_TOF_DEV0 for refer to first sensor
    *
    * 	@param[in]	AEK_TOF_ERROR *state -> state = AEK_TOF_NO_ERROR : Success ||  state = AEK_TOF_ERROR_CONFIGURATION : Error
    */
    FULL_GetErrorSensorState_ptr GetErrorSensorState;
    /*
	 ...
	 *
	 */
	FULL_SetIRQSensorState_ptr SetIRQSensorState;
    /*
	 ...
	 *
	 */
	FULL_GetIRQSensorState_ptr GetIRQSensorState;
	/*
	 ...
	 *
	 */
    FULL_TurnOnSensor_ptr TurnOnSensor;
	/*
	 ...
	 *
	 */
    FULL_TurnOffSensor_ptr TurnOffSensor;
    /*
     * 	@brief Turn on all sensor (Xshut state = 1)
	 */
    FULL_TurnOffAllSensors_ptr TurnOnAllSensors;
    /*
     * 	@brief Turn off all sensor (Xshut state = 0)
	 */
    FULL_TurnOnAllSensors_ptr TurnOffAllSensors;
    /**
     ...
     */
    FULL_GetVersion_ptr GetVersion;
    /**
	 ...
	 * @return  "Other error code"    See ::VL53L1_Error
	 */
    FULL_GetProductRevision_ptr GetProductRevision;
    /**
     ...
     * @return  "Other error code"  See ::VL53L1_Error
     */
    FULL_GetDeviceInfo_ptr GetDeviceInfo;
    /**
     ...
     * @return  "Other error code"  See ::VL53L1_Error
     */
    FULL_GetRangeStatusString_ptr GetRangeStatusString;
    /**
     ...
     * @return  "Other error code" See ::VL53L1_Error
     */
    FULL_GetPalErrorString_ptr GetPalErrorString;
    /**
     ...
     * @return  "Other error code"    See ::VL53L1_Error
     */
    FULL_GetPalStateString_ptr GetPalStateString;
    /**
     ...
     * @return  "Other error code"    See ::VL53L1_Error
     */
    FULL_GetPalState_ptr GetPalState;
    /**
     ...
     * @return  "Other error code"    See ::VL53L1_Error
     */
    FULL_SetDeviceAddress_ptr SetDeviceAddress;
    /**
     *
     ...
     * @return  "Other error code"    See ::VL53L1_Error
     */
    FULL_StaticInit_ptr StaticInit;
    /**
     ...
     *
     */
    FULL_WaitDeviceBooted_ptr WaitDeviceBooted;
    /**
     ...
     */
    FULL_SetPresetMode_ptr SetPresetMode;
     ...
     */
    FULL_GetPresetMode_ptr GetPresetMode;
    /**
    ...
    * @return  "Other error code"              See ::VL53L1_Error
    */
    FULL_SetDistanceMode_ptr SetDistanceMode;
    /**
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetDistanceMode_ptr GetDistanceMode;
    /**
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_SetMeasurementTimingBudgetMicroSeconds_ptr SetMeasurementTimingBudgetMicroSeconds;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetMeasurementTimingBudgetMicroSeconds_ptr GetMeasurementTimingBudgetMicroSeconds;
    /**
    * Program continuous mode Inter-Measurement period in milliseconds
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_SetInterMeasurementPeriodMilliSeconds_ptr SetInterMeasurementPeriodMilliSeconds;
     ...
     */
    FULL_GetInterMeasurementPeriodMilliSeconds_ptr GetInterMeasurementPeriodMilliSeconds;
    /**
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetNumberOfLimitCheck_ptr GetNumberOfLimitCheck;
    ...
    * @return  "Other error code"           See ::VL53L1_Error
    */
    FULL_GetLimitCheckInfo_ptr GetLimitCheckInfo;
    /**
    ...
    * @return  "Other error code"           See ::VL53L1_Error
    */
    FULL_GetLimitCheckStatus_ptr GetLimitCheckStatus;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_SetLimitCheckEnable_ptr SetLimitCheckEnable;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetLimitCheckEnable_ptr GetLimitCheckEnable;
    /**
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_SetLimitCheckValue_ptr SetLimitCheckValue;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetLimitCheckValue_ptr GetLimitCheckValue;
    /**
    * @brief  Get the current value of the signal used for the limit check
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetLimitCheckCurrent_ptr GetLimitCheckCurrent;
    /**
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_SetUserROI_ptr SetUserROI;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetUserROI_ptr GetUserROI;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetNumberOfSequenceSteps_ptr GetNumberOfSequenceSteps;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetSequenceStepsInfo_ptr GetSequenceStepsInfo;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_SetSequenceStepEnable_ptr SetSequenceStepEnable;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetSequenceStepEnable_ptr GetSequenceStepEnable;
     ...
     * @return  "Other error code"   See ::VL53L1_Error
     */
    FULL_StartMeasurement_ptr StartMeasurement;
     ...
     * @return  "Other error code"   See ::VL53L1_Error
     */
    FULL_StopMeasurement_ptr StopMeasurement;
     ...
     * @return  "Other error code"   See ::VL53L1_Error
     */
    FULL_ClearInterruptAndStartMeasurement_ptr ClearInterruptAndStartMeasurement;
     ...
     * @return  "Other error code"     See ::VL53L1_Error
     */
    FULL_GetMeasurementDataReady_ptr GetMeasurementDataReady;
     ...
     */
    FULL_WaitMeasurementDataReady_ptr WaitMeasurementDataReady;
     ...
     * @return  "Other error code"       See ::VL53L1_Error
     */
    FULL_GetRangingMeasurementData_ptr GetRangingMeasurementData;
    /**
     ...
     * @return  "Other error code"       See ::VL53L1_Error
     */
    FULL_SetTuningParameter_ptr SetTuningParameter;
     ...
     * @return  "Other error code"       See ::VL53L1_Error
     */
    FULL_GetTuningParameter_ptr GetTuningParameter;
     ...
     * @return  "Other error code"       See ::VL53L1_Error
     */
    FULL_PerformRefSpadManagement_ptr PerformRefSpadManagement;
     ...
     * @return  "Other error code"       See ::VL53L1_Error
    */
    FULL_SetXTalkCompensationEnable_ptr SetXTalkCompensationEnable;
     ...
     * @return  "Other error code"       See ::VL53L1_Error
     */
    FULL_GetXTalkCompensationEnable_ptr GetXTalkCompensationEnable;
     ...
     * @return  "Other error code"   See ::VL53L1_Error
     */
    FULL_PerformSingleTargetXTalkCalibration_ptr PerformSingleTargetXTalkCalibration;
     ...
     * @return  "Other error code"        See ::VL53L1_Error
     */
    FULL_SetOffsetCalibrationMode_ptr SetOffsetCalibrationMode;
     ...
     * @return  "Other error code"   See ::VL53L1_Error
     */
    FULL_PerformOffsetCalibration_ptr PerformOffsetCalibration;
     ...
     * @return  "Other error code"   See ::VL53L1_Error
     */
    FULL_PerformOffsetSimpleCalibration_ptr PerformOffsetSimpleCalibration;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_SetCalibrationData_ptr SetCalibrationData;
    /**
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetCalibrationData_ptr GetCalibrationData;
     ...
     * @return  "Other error code"           See ::VL53L1_Error
     */
    FULL_GetOpticalCenter_ptr GetOpticalCenter;
    /**
    ...
    */
    ...
    FULL_SetThresholdConfig_ptr SetThresholdConfig;
    ...
    */
    ...
    FULL_GetThresholdConfig_ptr GetThresholdConfig;
}methods_t;
/** @defgroup cut11_group VL53L1 cut1.1 Function Definition
 *  @brief    VL53L1 cut1.1 Function Definition
 *  @{
 */

/** @defgroup general_group VL53L1 General Functions
 ...
 * @return  "Other error code"    See ::VL53L1_Error
 */
VL53L1_Error FULL_GetProductRevision(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"  See ::VL53L1_Error
 */
VL53L1_Error FULL_GetDeviceInfo(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"  See ::VL53L1_Error
 */
VL53L1_Error FULL_GetRangeStatusString(uint8_t RangeStatus,
 ...
 * @return  "Other error code" See ::VL53L1_Error
 */
VL53L1_Error FULL_GetPalErrorString(VL53L1_Error PalErrorCode,
 ...
 * @return  "Other error code"    See ::VL53L1_Error
 */
VL53L1_Error FULL_GetPalStateString(VL53L1_State PalStateCode,
 ...
 * @return  "Other error code"    See ::VL53L1_Error
 */
VL53L1_Error FULL_GetPalState(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"    See ::VL53L1_Error
 */
VL53L1_Error FULL_SetDeviceAddress(AEK_TOF_DEV index,
 ...
 *                                          not in the supported list
 */
VL53L1_Error FULL_SetPresetMode(AEK_TOF_DEV index,
 ...
 * DeviceMode is not in the supported list
 */
VL53L1_Error FULL_GetPresetMode(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"              See ::VL53L1_Error
 */
VL53L1_Error FULL_SetDistanceMode(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetDistanceMode(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetNumberOfLimitCheck(
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetLimitCheckInfo(uint16_t LimitCheckId,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetLimitCheckStatus(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_SetLimitCheckEnable(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetLimitCheckEnable(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_SetLimitCheckValue(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetLimitCheckValue(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetLimitCheckCurrent(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_SetUserROI(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetUserROI(AEK_TOF_DEV index,
		VL53L1_UserRoi_t *pUserROi);
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetNumberOfSequenceSteps(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetSequenceStepsInfo(
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_SetSequenceStepEnable(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"           See ::VL53L1_Error
 */
VL53L1_Error FULL_GetSequenceStepEnable(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"     See ::VL53L1_Error
 */
VL53L1_Error FULL_GetMeasurementDataReady(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"       See ::VL53L1_Error
 */
VL53L1_Error FULL_GetRangingMeasurementData(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"       See ::VL53L1_Error
 */
VL53L1_Error FULL_SetTuningParameter(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"       See ::VL53L1_Error
 */
VL53L1_Error FULL_GetTuningParameter(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"       See ::VL53L1_Error
*/
VL53L1_Error FULL_SetXTalkCompensationEnable(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"       See ::VL53L1_Error
 */
VL53L1_Error FULL_GetXTalkCompensationEnable(AEK_TOF_DEV index,
 ...
 * @return  "Other error code"   See ::VL53L1_Error
 */
VL53L1_Error FULL_PerformSingleTargetXTalkCalibration(AEK_TOF_DEV index,
...
/**
* @brief Retrieves the interrupt config structure currently programmed into the API
*
* @param[in]    Dev     : Device Handle
* @param[out]   pConfig : pointer to configuration structure
*/
...
void FULL_TurnOnAllSensors(void);

void FULL_TurnOffAllSensors(void);

AEK_TOF_ERROR FULL_CreateSensor(AEK_TOF_DEV index,uint8_t Dev,uint8_t XshutPort,uint8_t XshutPin);

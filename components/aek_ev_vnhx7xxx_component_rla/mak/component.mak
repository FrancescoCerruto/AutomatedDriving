...
LIB_C_SRC       += ./components/aek_ev_vnhx7xxx_component_rla/lib/src/EV_VNHx7xxx.c
LIB_CPP_SRC     +=
LIB_ASM_SRC     += 
LIB_INCLUDES    += ./components/aek_ev_vnhx7xxx_component_rla/lib/include

##############################################################################
# References to the application locations.

APP_C_SRC       += ./components/aek_ev_vnhx7xxx_component_rla/cfg/EV_VNHx7xxx_cfg.c

APP_CPP_SRC     +=

APP_ASM_SRC     +=

APP_INCLUDES    += ./components/aek_ev_vnhx7xxx_component_rla/cfg
